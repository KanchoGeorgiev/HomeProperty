            ...
            <WrapperCard>
                <BackgroundCard>
                    <div className="flex">
                        ...
                        <div className="w-2/5 break-all bg-neutral-600">
                            <h1 className="text-white text-3xl text-center mt-6">
                                Contacts
                            </h1>
                            <p className="text-white m-4">
                                Please, feel free to contact us regarding
                                anything related to this website or any of the
                                listings posted in it.
                            </p>
                            <p className="text-white m-4">
                                Work hours: Mon-Fri
                            </p>
                            <p className="text-white m-4">08:00-20:00</p>
