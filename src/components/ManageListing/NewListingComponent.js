                ...
                <div className="flex ">
                    ...
                    >
                        <div className="mb-5">
                            ...
                            <label
                                for="countries"
                                class="block my-4 text-sm font-medium text-gray-900 dark:text-gray-400"
                            >
                            ...
                            <select
                                ...
                                id="countries"
                                class="bg-white mb-12 py-3 px-5 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
